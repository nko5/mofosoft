...
~~~sh
# getting the code
git clone git@github.com:nko5/mofosoft.git && cd ./mofosoft/
...
# deploying to Modulus (to http://mofosoft.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/mofosoft" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
